...
public final class ActivityDonationBinding implements ViewBinding {
  ...
  private ActivityDonationBinding(@NonNull RelativeLayout rootView, @NonNull ViewPager viewPager) {
  ...
  public static ActivityDonationBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityDonationBinding((RelativeLayout) rootView, viewPager);
    }
